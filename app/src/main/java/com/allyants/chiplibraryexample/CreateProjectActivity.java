...
import com.allyants.chiplibraryexample.HTTPAsyncTask;
...
public class CreateProjectActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        knifetxt=(KnifeText)findViewById(R.id.titletxt);
        ...
        for(int i=0;i<count;i++){
            {
                try {
                    json.put("skill"+i,m.group(i));
                } catch (JSONException e) {
                    e.printStackTrace();
                }
            }
        }
        String title=knifetxt.getText().toString();
        String descp=knife.getText().toString();
        try {
            json.put("Title",title);
            json.put("Descp",descp);
        } catch (JSONException e) {
            e.printStackTrace();
        }
        ...
        btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                //      HttpPost("POST /projects",json);
                HTTPAsyncTask htp=new HTTPAsyncTask();
                try {
                    htp.HttpPost("POST /projects",json);
                } catch (IOException e) {
                    e.printStackTrace();
                } catch (JSONException e) {
                    e.printStackTrace();
    ...
    private void setupBold() {
        ...
        bold.setOnLongClickListener(new View.OnLongClickListener() {
            ...
            public boolean onLongClick(View v) {
                Toast.makeText(getApplicationContext(), R.string.toast_bold, Toast.LENGTH_SHORT).show();
                return true;
            }
        });
    }
    ...
    private void setupItalic() {
        ...
        italic.setOnLongClickListener(new View.OnLongClickListener() {
            @Override
            public boolean onLongClick(View v) {
                Toast.makeText(getApplicationContext(), R.string.toast_italic, Toast.LENGTH_SHORT).show();
                return true;
            }
        });
    }
    ...
    private void setupUnderline() {
        ...
        underline.setOnLongClickListener(new View.OnLongClickListener() {
            @Override
            public boolean onLongClick(View v) {
                Toast.makeText(getApplicationContext(), R.string.toast_underline, Toast.LENGTH_SHORT).show();
                return true;
            }
        });
    }
    ...
    private void setupStrikethrough() {
        ...
        strikethrough.setOnLongClickListener(new View.OnLongClickListener() {
            @Override
            public boolean onLongClick(View v) {
                Toast.makeText(getApplicationContext(), R.string.toast_strikethrough, Toast.LENGTH_SHORT).show();
                return true;
            }
        });
    }
    ...
    private void setupBullet() {
        ...
        bullet.setOnLongClickListener(new View.OnLongClickListener() {
            @Override
            public boolean onLongClick(View v) {
                Toast.makeText(getApplicationContext(), R.string.toast_bullet, Toast.LENGTH_SHORT).show();
                return true;
            }
        });
    }
    ...
    private void setupQuote() {
        ...
        quote.setOnLongClickListener(new View.OnLongClickListener() {
            @Override
            public boolean onLongClick(View v) {
                Toast.makeText(getApplicationContext(), R.string.toast_quote, Toast.LENGTH_SHORT).show();
                return true;
            }
        });
    }
    ...
    private void setupLink() {
        ...
        link.setOnLongClickListener(new View.OnLongClickListener() {
            @Override
            public boolean onLongClick(View v) {
                Toast.makeText(getApplicationContext(), R.string.toast_insert_link, Toast.LENGTH_SHORT).show();
                return true;
            }
        });
    }
    ...
    private void setupClear() {
        ...
        clear.setOnLongClickListener(new View.OnLongClickListener() {
            @Override
            public boolean onLongClick(View v) {
                Toast.makeText(getApplicationContext(), R.string.toast_format_clear, Toast.LENGTH_SHORT).show();
                return true;
            }
        });
    }
